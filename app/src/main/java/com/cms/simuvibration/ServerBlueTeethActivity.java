...
import com.cms.util.BluetoothChat;

public class ServerBlueTeethActivity extends Activity {
    ...
    public synchronized void onResume() {
        ...
        if (mChatService != null) {
            ...
            if (mChatService.getState() == BluetoothChat.STATE_NONE) {
    ...
    public void onStart() {
        ...
        if (null == mChatService)
            mChatService = new BluetoothChat(this, mHandler);
    }
